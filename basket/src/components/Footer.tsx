import { Ifooter, productsprushared } from '../interface';

export default function Footer({ footerNavigation }: Ifooter) {
  return (
    <footer
              ...
              <div className="grid grid-cols-1 gap-y-12 sm:col-span-2 sm:grid-cols-2 sm:gap-x-8">
                <div>
                  ...
                  <ul role="list" className="mt-6 space-y-6">
                    {footerNavigation.productsprushared.map(
                      (item: productsprushared) => (
                ...
                <div>
                  ...
                  <ul role="list" className="mt-6 space-y-6">
                    {footerNavigation.company.map((item: productsprushared) => (
                      <li key={item.name} className="text-sm">
                        <a
                          href={item.href}
                          className="text-gray-500 hover:text-gray-600"
